...
from gadmpy.__version__ import version as __version__
...
latex_documents = [
    (master_doc, 'gadmpy.tex', u'gadmpy Documentation',
...
man_pages = [
    (master_doc, 'gadmpy', u'gadmpy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'gadmpy', u'gadmpy Documentation',
     author, 'gadmpy', 'tools for downloading and using gadm shape files for making map plots',
     'Miscellaneous'),
]
